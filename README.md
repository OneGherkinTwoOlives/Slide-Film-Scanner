...
The project uses two stepper motors although you could eliminate the one that raises and lowers the trash (return) platform and just allow the slides to drop out. 
...
*  Various bearing and 3mm and 5mm rods. 
